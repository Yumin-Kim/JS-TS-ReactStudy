import { Model, DataTypes, BelongsTo, BelongsToManyGetAssociationsMixin, BelongsToManyRemoveAssociationMixin, HasManyGetAssociationsMixin, BelongsToManyAddAssociationMixin } from 'sequelize';
