...
function 그리기() {
  데이터.forEach(function(열데이터, i) {
    열데이터.forEach(function(행데이터, j) {
      if (행데이터 > 0) {
        if(테이블)
        테이블.children[i].children[j].textContent = String(행데이터) ;
      } else {
        if(테이블)
        ...
        열데이터.forEach(function(행데이터, j) {
          if (행데이터) {
            if (새데이터[i][새데이터[i].length - 1] && 새데이터[i][새데이터[i].length - 1] === 행데이터) {
              ...
              if(점수표){
                var 현점수 = parseInt(String(점수표.textContent), 10);
                점수표.textContent = String(현점수 + 새데이터[i][새데이터[i].length - 1]);
              }
            } else {
              새데이터[i].push(행데이터);
            }
        ...
        열데이터.forEach(function(행데이터, j) {
          if (행데이터) {
            if (새데이터[i][0] && 새데이터[i][0] === 행데이터) {
              새데이터[i][0] *= 2;
              if(점수표 && 점수표.textContent ){
                var 현점수 = parseInt(점수표.textContent, 10);
                점수표.textContent = String(현점수 + 새데이터[i][0]);
              }
            } else {
              새데이터[i].unshift(행데이터);
            }
        ...
        열데이터.forEach(function(행데이터, j) {
          if (행데이터) {
            if (새데이터[j][새데이터[j].length - 1] && 새데이터[j][새데이터[j].length - 1] === 행데이터) {
              ...
              if(점수표 && 점수표.textContent){
                var 현점수 = parseInt(점수표.textContent, 10);
                점수표.textContent = String(현점수 + 새데이터[j][새데이터[j].length - 1]);
              }
            } else {
              새데이터[j].push(행데이터);
            }
        ...
        열데이터.forEach(function(행데이터, j) {
          if (행데이터) {
            if (새데이터[j][0] && 새데이터[j][0] === 행데이터) {
              ...
              if(점수표 && 점수표.textContent){
                var 현점수 = parseInt(점수표.textContent, 10);
                점수표.textContent = String(현점수 + 새데이터[j][0]);
              }
            } else {
              새데이터[j].unshift(행데이터);
            }
